...
//  Network
//
//  Created by DHSD on 2018/5/31.
//  Copyright © 2018年 DHSD. All rights reserved.
//

#import "SessionDemo.h"

@interface SessionDemo ()<NSURLSessionDelegate>

@property (strong, nonatomic) NSMutableData *responseData;

@end

@implementation SessionDemo
...
-(NSString *)descriptionWith:(NSDictionary *)info
{
    //初始化可变字符串
